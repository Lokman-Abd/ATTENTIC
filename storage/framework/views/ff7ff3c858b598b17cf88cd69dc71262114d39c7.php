  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div id="formContainer" class="card mb-4">
        <?php echo $__env->make('typing.Includes.create_module_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
      <!-- Input Group -->
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="table-responsive p-3">
              <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td></td>
                    <td><?php echo e($module['short_cut']); ?></td>
                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($type->hasThisModule($module->module_id)): ?>
                    <td><i class="purple-icon fas fa-fw fa-check"></i></td>
                    <?php else: ?>
                    <td><i class="red-icon fas fa-times"></i></td>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <td><i id='editButton' data-module-id="<?php echo e($module['module_id']); ?>" class='purple-icon fas fa-fw fa-edit'></i></td>
                    <td><i id='deleteButton' data-module-id="<?php echo e($module['module_id']); ?>" data-module-name="<?php echo e($module['short_cut']); ?>" data-toggle="modal" data-target="#exampleModal" class='purple-icon fas fa-fw fa-trash'></i></td>
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
              </table>
...
<script>
  $(document).ready(function() {
    ...
    $(document).on("click", '#submit', function() {
      ...
      $.post("<?php echo e(route('storeTyping')); ?>", {
    ...
    $(document).on("click", "#deleteButton", function() {
      ...
      $.post("<?php echo e(route('getTypes')); ?>", {
        '_token': "<?php echo e(csrf_token()); ?>",
        'id': moduleId
      }, function(response) {
      ...
      `;
          ...
          confirmDialog(YOUR_MESSAGE_STRING_CONST, function() {
            ...
            $.post("<?php echo e(route('destroyTyping')); ?>", {
              _token: "<?php echo e(csrf_token()); ?>",
              data: {
                module_id: moduleId,
                types: typesToDelete
    ...
    $(document).on("click", "#editButton", function() {
      ...
      $.post("<?php echo e(route('editTyping')); ?>", {
        '_token': "<?php echo e(csrf_token()); ?>",
        'id': ModuleId
      }, function(response) {
    ...
    $(document).on('click', '#update', function() {
      ...
      $.post("<?php echo e(route('updateTyping')); ?>", {
        '_token': "<?php echo e(csrf_token()); ?>",
        'data': allData
      }, function(response) {
...
</html><?php /**PATH C:\Users\Lokmane\Desktop\example-app\resources\views/typing/manageTyping.blade.php ENDPATH**/ ?>